"""
Frozen legacy implementations of the simultaneous RKHS IV estimators.

This module snapshots ``rkhs2iv.py`` at repository commit
``38e36748f7a77ee1a64d45ae7437ae3501fadcb8`` before the controlled RKHS
revisions. Numerical code is unchanged; only class names are suffixed with
``_legacy`` so old and new estimators can be imported together.

Classes:
    _BaseRKHS2IV_legacy: Frozen base class for simultaneous RKHS IV methods.
    RKHS2IV_legacy: Frozen alternate simultaneous estimator.
    RKHS2IVCV_legacy: Frozen cross-validated alternate estimator.
    RKHS2IVL2_legacy: Frozen Appendix J / Algorithm 2 estimator.
    RKHS2IVL2CV_legacy: Frozen cross-validated Appendix J estimator.
    ApproxRKHS2IV_legacy: Frozen approximate alternate estimator.
    ApproxRKHS2IVCV_legacy: Frozen cross-validated approximate estimator.
    ApproxRKHS2IVL2_legacy: Frozen approximate Appendix J estimator.
    ApproxRKHS2IVL2CV_legacy: Frozen cross-validated approximate L2 estimator.
"""
...
class RKHS2IV_legacy(_BaseRKHS2IV_legacy):
    """
...
class RKHS2IVCV_legacy(RKHS2IV_legacy):
    """
...
class RKHS2IVL2_legacy(_BaseRKHS2IV_legacy):
    """
...
class RKHS2IVL2CV_legacy(RKHS2IVL2_legacy):
    """
...
class ApproxRKHS2IVL2_legacy(_BaseRKHS2IV_legacy):
    """
...
class ApproxRKHS2IVL2CV_legacy(ApproxRKHS2IVL2_legacy):
    """
...
class ApproxRKHS2IV_legacy(ApproxRKHS2IVL2_legacy):
    """
...
class ApproxRKHS2IVCV_legacy(ApproxRKHS2IV_legacy):
    """
